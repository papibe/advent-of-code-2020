def solution(filename):
    ...
    def syntaxParsing(tokens):
        ...
        for token in tokens:
            ...
            if isOperator(token):
                while   operators   \
                        and (not isOpenParen(operators[-1])) \
...
if __name__ == "__main__":
    print(solution("./inputs/example1.txt"))    # 231
    print(solution("./inputs/example2.txt"))    # 51
    print(solution("./inputs/example3.txt"))    # 46
    print(solution("./inputs/example4.txt"))    # 1445
    print(solution("./inputs/example5.txt"))    # 669060
    print(solution("./inputs/example6.txt"))    # 23340
